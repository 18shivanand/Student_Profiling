...
urlpatterns = [
    ...
    path('projects/create_projects', views.create_projects, name='create_projects'),
    path('projects/update_projects', views.update_projects, name='update_projects'),
    path('projects/delete_projects/<int:id>', views.delete_projects, name='delete_projects'),
    ...
    path('list/<int:id>/', views.download, name='download'),
